    ...
    <section id="how-it-works" className="bg-brand-bg px-6 py-24">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {STEPS.map((step) => (
            <div key={step.number} className="rounded-xl border border-white/8 bg-brand-surface p-6">
              <span className="font-mono text-3xl font-bold text-brand-primary">{step.number}</span>
