...
as $$
  select *
  from public.create_dare_action(
    p_issuer_id => p_issuer_id,
    p_title => p_title,
    p_description => p_description,
    p_category => p_category,
    p_resolution_type => 'answer_key',
    p_stake_amount => p_stake_amount,
    p_currency => p_currency,
    p_duration_seconds => p_duration_seconds,
    p_target_username => p_target_username,
    p_constitution_test => p_constitution_test,
    p_constitution_rules => p_constitution_rules,
    p_constitution_proof_method => p_constitution_proof_method,
    p_constitution_edge_cases => p_constitution_edge_cases,
    p_ledger_idempotency_key => p_ledger_idempotency_key
  );
$$;
